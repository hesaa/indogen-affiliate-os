import { User, Settings, TrendingUp, Package, ShoppingCart, DollarSign, LogOut, Activity, FileText, Link, MessageSquare, Home } from 'lucide-react'
...
export default function DashboardLayout({
  ...
  const menuItems = [
    ...
    { href: '/dashboard/links', label: 'Cloaked Links', icon: Link },
          ...
          <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Package className="h-5 w-5 text-gray-400 cursor-pointer hover:text-gray-600" />
                <ShoppingCart className="h-5 w-5 text-gray-400 cursor-pointer hover:text-gray-600" />
              </div>

              <button
                onClick={handleLogout}
                className="flex items-center space-x-2 px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md transition-colors"
              >
